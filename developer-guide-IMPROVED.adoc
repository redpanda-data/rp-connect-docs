...
| Redpanda CLI
| xref:get-started:quickstarts/rpk.adoc[Install rpk]
| Yes

| Redpanda Connect
| Version 4.56.0 or later. xref:get-started:upgrade/rpk-upgrade.adoc[Upgrade guide]
| Yes

| Basic knowledge
| YAML, HTTP APIs, event streams
| Recommended

| MCP client
| Claude Code, Desktop, or link:https://modelcontextprotocol.io/clients[other client^]
| For testing
|===
...
[[publish]]
== Step 6: Publish your MCP server (optional)
