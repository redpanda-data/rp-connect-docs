...
:description: Learn how to move from legacy migrator components to the unified redpanda_migrator input/output pair in Redpanda Connect 4.66.0+.
...
* **Available:** Redpanda Connect 4.66.0+
* **Legacy migrator components status:** Deprecated in 4.66.0
