...
* OAuth, basic authentication, and JSON Web Token fields to the `schema_registry` xref:components:inputs/schema_registry.adoc[input] and xref:components:outputs/schema_registry.adoc[output].
