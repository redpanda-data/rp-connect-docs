...
:personas: ai_agent_developer, streaming_platform_developer, ai_product_builder
...
<4> A clear description for LLMs helps Claude understand what the tool does. See xref:ai-agents:mcp-server/reference.adoc#contract[MCP metadata reference].
...
* xref:ai-agents:mcp-server/tool-patterns.adoc[]: Find reusable examples for database queries, Redpanda integration, and AI/LLM calls
* xref:ai-agents:mcp-server/concepts.adoc[]: Learn how MCP tools differ from pipelines and when to use each component type
* xref:ai-agents:mcp-server/reference.adoc[]: Look up YAML rules, property restrictions, and MCP metadata options
