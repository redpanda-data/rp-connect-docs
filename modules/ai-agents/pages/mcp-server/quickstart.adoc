...
<4> A clear description for LLMs helps Claude understand what the tool does. For more details, see xref:ai-agents:mcp-server/create-tool.adoc#anatomy[Anatomy of an MCP tool].
