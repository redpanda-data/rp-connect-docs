= MCP Tool Patterns
:description: Catalog of reusable patterns for building MCP tools with Redpanda Connect.
:page-aliases: ai-agents:mcp-server/pipeline-patterns.adoc
:page-topic-type: reference
:personas: ai_agent_developer, data_engineer_pipeline_architect, ml_platform_engineer
// Reader journey: "I need to look up a pattern"
:learning-objective-1: Find reusable patterns for common MCP tool scenarios

This page provides a reference catalog of patterns designed for use with Redpanda Connect MCP servers. Use these patterns as building blocks for your own MCP tools.
