...
NOTE: The `jira` processor requires an Enterprise license. See xref:get-started:licensing.adoc[].
...
See xref:cookbooks:jira.adoc[] for more patterns including pagination, custom fields, and creating issues via the HTTP processor.
