...
* <<robust-implementation,Input validation, error handling, and response formatting>>
...
Build production-ready tools with proper input validation, error handling, and response formatting. These patterns help your tools handle edge cases gracefully and return consistent responses to AI clients.
...
include::ai-agents:partial$mcp/best-practices/input-validation.adoc[leveloffset=+1]
...
include::ai-agents:partial$mcp/best-practices/error-handling.adoc[leveloffset=+1]

=== Response formatting

AI clients work best with clean, predictable response structures. Transform raw component output into consistent formats.

include::ai-agents:partial$mcp/best-practices/response-formatting.adoc[leveloffset=+1]
