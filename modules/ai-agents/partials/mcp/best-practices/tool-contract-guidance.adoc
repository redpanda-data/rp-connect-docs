// =============================================================================
// PARTIAL: tool-contract-guidance.adoc
// =============================================================================
//
// INCLUDED BY:
...
//
// INCLUDE SYNTAX:
//   Connect: include::ai-agents:partial$mcp/best-practices/tool-contract-guidance.adoc[]
//   Cloud:   include::redpanda-connect:ai-agents:partial$mcp/best-practices/tool-contract-guidance.adoc[]
//
// ATTRIBUTES USED:
//   None
//
