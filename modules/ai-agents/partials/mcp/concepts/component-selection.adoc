...
Consider a scenario where an AI assistant needs to remember user preferences across multiple tool calls within a conversation.
...
Consider a scenario where an AI assistant frequently looks up the same reference data (like exchange rates or product catalogs) and you want to avoid repeated API calls.
