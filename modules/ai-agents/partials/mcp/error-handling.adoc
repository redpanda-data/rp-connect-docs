// Single-sourced partial for error handling best practices
// Used in Connect best-practices.adoc and Cloud best-practices.adoc
//
// Include from Connect: include::ai-agents:partial$mcp/error-handling.adoc[]
// Include from Cloud: include::redpanda-connect:ai-agents:partial$mcp/error-handling.adoc[]
