// Single-sourced partial for MCP execution model
// Used in both Connect and Cloud developer guides
//
// Include from Connect: include::ai-agents:partial$mcp/execution-model.adoc[]
// Include from Cloud: include::redpanda-connect:ai-agents:partial$mcp/execution-model.adoc[]
