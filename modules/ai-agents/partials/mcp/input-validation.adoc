// Single-sourced partial for input validation best practices
// Used in Connect best-practices.adoc and Cloud best-practices.adoc
//
// Include from Connect: include::ai-agents:partial$mcp/input-validation.adoc[]
// Include from Cloud: include::redpanda-connect:ai-agents:partial$mcp/input-validation.adoc[]
