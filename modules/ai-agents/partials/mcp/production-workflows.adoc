// Consolidated partial for production workflows
// Used by both self-managed Redpanda Connect and Remote MCP servers in Cloud
//
// Include from Connect: include::ai-agents:partial$mcp/production-workflows.adoc[]
// Include from Cloud: include::redpanda-connect:ai-agents:partial$mcp/production-workflows.adoc[]
...
ifdef::env-cloud[]
include::ai-agents:partial$mcp/secrets-cloud.adoc[]
endif::[]
ifndef::env-cloud[]
