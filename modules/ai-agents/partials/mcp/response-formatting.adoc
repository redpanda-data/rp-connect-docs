// Single-sourced partial for response formatting best practices
// Used in Connect best-practices.adoc and Cloud best-practices.adoc
//
// Include from Connect: include::ai-agents:partial$mcp/response-formatting.adoc[]
// Include from Cloud: include::redpanda-connect:ai-agents:partial$mcp/response-formatting.adoc[]
