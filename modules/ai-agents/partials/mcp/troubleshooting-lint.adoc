// Single-sourced partial for lint error troubleshooting
// Used in Connect troubleshooting.adoc and Cloud troubleshooting.adoc
//
// Include from Connect: include::ai-agents:partial$mcp/troubleshooting-lint.adoc[]
// Include from Cloud: include::redpanda-connect:ai-agents:partial$mcp/troubleshooting-lint.adoc[]
