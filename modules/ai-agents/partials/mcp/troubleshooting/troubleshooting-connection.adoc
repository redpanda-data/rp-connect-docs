// =============================================================================
// PARTIAL: troubleshooting-connection.adoc
// =============================================================================
//
// INCLUDED BY:
...
//
// INCLUDE SYNTAX:
//   Connect: include::ai-agents:partial$mcp/troubleshooting/troubleshooting-connection.adoc[]
//   Cloud:   include::redpanda-connect:ai-agents:partial$mcp/troubleshooting/troubleshooting-connection.adoc[]
//
// ATTRIBUTES USED:
//   - env-cloud: Switches troubleshooting steps for Cloud vs self-managed
//
// DEPENDENCIES:
//   None
// =============================================================================
