...
```yml
include::components:example$common/buffers/sqlite.yaml[]
```
...
```yml
include::components:example$advanced/buffers/sqlite.yaml[]
```
...
include::connect:components:partial$fields/buffers/sqlite.adoc[]

nclude::connect:components:partial$examples/buffers/sqlite.adoc[]
