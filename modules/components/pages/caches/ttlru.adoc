...
```yml
include::components:example$common/caches/ttlru.yaml[]
```
...
```yml
include::components:example$advanced/caches/ttlru.yaml[]
```
...
include::connect:components:partial$fields/caches/ttlru.adoc[]
