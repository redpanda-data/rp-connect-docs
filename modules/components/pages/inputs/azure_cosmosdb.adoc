...
:categories: ["Azure"]
// tag::meta[]
:description: Executes a SQL query against https://learn.microsoft.com/en-us/azure/cosmos-db/introduction[Azure CosmosDB^] and creates a batch of messages from each page of items.
// end::meta[]
