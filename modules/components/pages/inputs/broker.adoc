...
```yml
include::components:example$common/inputs/broker.yaml[]
```
...
```yml
include::components:example$advanced/inputs/broker.yaml[]
```
...
include::connect:components:partial$fields/inputs/broker.adoc[]
