= http_server
// tag::single-source[]
:page-commercial-names: HTTP, REST API, REST, Gateway
:type: input
:status: stable
:categories: ["Network"]
...
```yml
include::components:example$common/inputs/http_server.yaml[]
```
...
```yml
include::components:example$advanced/inputs/http_server.yaml[]
```
...
include::connect:components:partial$examples/inputs/http_server.adoc[]

include::connect:components:partial$fields/inputs/http_server.adoc[]
// end::single-source[]
