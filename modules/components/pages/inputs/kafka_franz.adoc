...
:categories: ["Services"]
// tag::meta[]
:description: A Kafka input using the https://github.com/twmb/franz-go[Franz Kafka client library^].
// end::meta[]
...
include::connect:components:partial$fields/inputs/kafka_franz.adoc[]
