...
:categories: ["Services"]
// tag::meta[]
:description: Enables MySQL streaming for RedPanda Connect.
// end::meta[]
...
```yml
include::components:example$common/inputs/mysql_cdc.yaml[]
```
...
```yml
include::components:example$advanced/inputs/mysql_cdc.yaml[]
```
...
include::connect:components:partial$metadata/inputs/mysql_cdc.adoc[]

include::connect:components:partial$fields/inputs/mysql_cdc.adoc[]
