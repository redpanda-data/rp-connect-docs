...
```yml
include::components:example$common/inputs/nats_stream.yaml[]
```
...
```yml
include::components:example$advanced/inputs/nats_stream.yaml[]
```
...
include::connect:components:partial$fields/inputs/nats_stream.adoc[]
