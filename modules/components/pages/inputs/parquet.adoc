= parquet
:type: input
:commercial-names: Parquet
:status: experimental
:categories: ["Local"]
// tag::meta[]
:description: Reads and decodes https://parquet.apache.org/docs/[Parquet files^] into a stream of structured messages.
// end::meta[]
...
include::connect:components:partial$fields/inputs/parquet.adoc[]
