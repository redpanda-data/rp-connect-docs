...
```yml
include::components:example$common/inputs/redpanda_common.yaml[]
```
...
```yml
include::components:example$advanced/inputs/redpanda_common.yaml[]
```
...
include::connect:components:partial$fields/inputs/redpanda_common.adoc[]
