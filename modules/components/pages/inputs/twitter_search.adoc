...
```yml
include::components:example$common/inputs/twitter_search.yaml[]
```
...
```yml
include::components:example$advanced/inputs/twitter_search.yaml[]
```
...
include::connect:components:partial$fields/inputs/twitter_search.adoc[]
