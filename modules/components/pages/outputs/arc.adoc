...
```yml
include::components:example$common/outputs/arc.yaml[]
```
...
```yml
include::components:example$advanced/outputs/arc.yaml[]
```

--
======

include::redpanda-connect:components:partial$fields/outputs/arc.adoc[]
