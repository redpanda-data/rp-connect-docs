...
// tag::meta[]
:description: Sends messages to an SQS queue.
// end::meta[]
...
```yml
include::components:example$common/outputs/aws_sqs.yaml[]
```
...
```yml
include::components:example$advanced/outputs/aws_sqs.yaml[]
```
...
include::connect:components:partial$fields/outputs/aws_sqs.adoc[]
