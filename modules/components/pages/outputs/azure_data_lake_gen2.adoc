...
:type: output
// tag::meta[]
:description: Sends message parts as files to an Azure Data Lake Gen2 filesystem. Each file is uploaded with the filename specified with the path field.
// end::meta[]
...
include::connect:components:partial$fields/outputs/azure_data_lake_gen2.adoc[]
