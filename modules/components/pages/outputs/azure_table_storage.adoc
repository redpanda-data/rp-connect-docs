...
```yml
include::components:example$common/outputs/azure_table_storage.yaml[]
```
...
```yml
include::components:example$advanced/outputs/azure_table_storage.yaml[]
```
...
include::connect:components:partial$fields/outputs/azure_table_storage.adoc[]
