...
Perform operations against a Couchbase database for each message to store or delete data.
...
Choose from the following Couchbase transcoders to convert the format of the data before it is written.
