...
// tag::meta[]
:description: Performs operations against Couchbase for each message, allowing you to store or delete data.
// end::meta[]
...
include::connect:components:partial$fields/outputs/couchbase.adoc[]
