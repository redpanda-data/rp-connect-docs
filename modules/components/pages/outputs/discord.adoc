...
// tag::meta[]
:description: Writes messages to a Discord channel.
// end::meta[]
...
```yml
include::components:example$common/outputs/discord.yaml[]
```
...
include::connect:components:partial$fields/outputs/discord.adoc[]
