...
For more patterns on message routing, filtering, and when to use `drop` vs. other approaches, see the xref:connect:cookbooks:message_routing.adoc[Message Routing Patterns] cookbook.
