...
```yml
include::components:example$common/outputs/drop_on.yaml[]
```
...
include::connect:components:partial$fields/outputs/drop_on.adoc[]

nclude::connect:components:partial$examples/outputs/drop_on.adoc[]
