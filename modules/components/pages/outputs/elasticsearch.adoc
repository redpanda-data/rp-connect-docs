...
NOTE: The underlying library for this output has been deprecated. The elasticsearch_v8 output offers and up-to-date connector based on the the https://github.com/elastic/go-elasticsearch?tab=readme-ov-file[go-elasticsearch/v8] library. For full information about Elasticsearch breaking changes and version compatibility, see Elastic's Migrating to 8.0 guide. 
