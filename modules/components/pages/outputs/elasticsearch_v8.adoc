...
```yml
include::components:example$common/outputs/elasticsearch_v8.yaml[]
```
...
```yml
include::components:example$advanced/outputs/elasticsearch_v8.yaml[]
```
...
include::connect:components:partial$fields/outputs/elasticsearch_v8.adoc[]
