...
The following examples show how to configure mapping processors with this output to achieve different types of update.
...
output:
  processors:
    ...
    # If the product with the specified ID exists, updates its `product_price` to `100`.
