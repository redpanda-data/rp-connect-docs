= gcp_bigquery
// tag::single-source[]
:page-commercial-names: Google BigQuery, GCP BigQuery, BigQuery
:type: output
:commercial-names: GCP BigQuery
:status: beta
...
include::connect:components:partial$fields/outputs/gcp_bigquery.adoc[]
