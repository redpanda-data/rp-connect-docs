...
```yml
include::components:example$common/outputs/gcp_cloud_storage.yaml[]
```
...
```yml
include::components:example$advanced/outputs/gcp_cloud_storage.yaml[]
```
...
include::connect:components:partial$fields/outputs/gcp_cloud_storage.adoc[]
