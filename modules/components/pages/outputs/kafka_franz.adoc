...
:categories: ["Services"]
// tag::meta[]
:description: A Kafka output using the https://github.com/twmb/franz-go[Franz Kafka client library^].
// end::meta[]
...
include::connect:components:partial$fields/outputs/kafka_franz.adoc[]
