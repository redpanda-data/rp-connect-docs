...
Migrates offset data to a Redpanda cluster. To achieve this, pair the `legacy_redpanda_migrator_offsets` output with a matching xref:components:outputs/redpanda_migrator_bundle.adoc[`redpanda_migrator_bundle` input].
