...
Use this connector in conjunction with the xref:components:inputs/redpanda.adoc[`redpanda` input], if you need to move topic data between Redpanda clusters, or other Apache Kafka clusters.
