...
:categories: ["Services"]
// tag::meta[]
:description: Sends data to a Redpanda (Kafka) broker, using credentials defined in a common top-level redpanda config block.
// end::meta[]
...
include::connect:components:partial$fields/outputs/redpanda_common.adoc[]
