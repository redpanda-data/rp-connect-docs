...
```yml
include::components:example$common/outputs/retry.yaml[]
```
...
```yml
include::components:example$advanced/outputs/retry.yaml[]
```
...
include::connect:components:partial$fields/outputs/retry.adoc[]
