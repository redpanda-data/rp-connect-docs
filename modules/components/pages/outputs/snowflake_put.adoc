...
```yml
include::components:example$common/outputs/snowflake_put.yaml[]
```
...
```yml
include::components:example$advanced/outputs/snowflake_put.yaml[]
```
...
include::connect:components:partial$examples/outputs/snowflake_put.adoc[]

include::connect:components:partial$fields/outputs/snowflake_put.adoc[]
