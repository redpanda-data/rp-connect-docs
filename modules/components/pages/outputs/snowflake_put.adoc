...
NOTE: For improved performance, cost effectiveness and ease of use, Redpanda recommends that you migrate to the xref:components:outputs/snowflake_streaming.adoc[`snowflake_streaming` output].
