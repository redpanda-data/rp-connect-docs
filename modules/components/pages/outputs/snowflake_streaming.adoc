...
```yml
include::components:example$common/outputs/snowflake_streaming.yaml[]
```
...
```yml
include::components:example$advanced/outputs/snowflake_streaming.yaml[]
```
...
include::connect:components:partial$fields/outputs/snowflake_streaming.adoc[]
