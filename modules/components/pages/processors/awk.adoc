= awk
:type: processor
:commercial-names: AWK
:status: stable
:categories: ["Mapping"]
// tag::meta[]
:description: Executes an AWK program on messages. This processor is very powerful as it offers a range of <<awk-functions,custom functions>> for querying and mutating message contents and metadata.
// end::meta[]
...
include::connect:components:partial$fields/processors/awk.adoc[]

include::connect:components:partial$examples/processors/awk.adoc[]
