...
:categories: ["Azure"]
// tag::meta[]
:description: Creates or updates messages as JSON documents in https://learn.microsoft.com/en-us/azure/cosmos-db/introduction[Azure CosmosDB^].
// end::meta[]
...
include::connect:components:partial$metadata/processors/azure_cosmosdb.adoc[]
...
include::connect:components:partial$examples/processors/azure_cosmosdb.adoc[]

include::connect:components:partial$fields/processors/azure_cosmosdb.adoc[]
