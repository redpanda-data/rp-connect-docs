...
:categories: ["AI"]
// tag::meta[]
:description: Generates responses to messages in a chat conversation, using the Cohere API.
// end::meta[]
...
include::connect:components:partial$fields/processors/cohere_chat.adoc[]
