...
include::connect:components:partial$examples/processors/cohere_embeddings.adoc[]

include::connect:components:partial$fields/processors/cohere_embeddings.adoc[]
