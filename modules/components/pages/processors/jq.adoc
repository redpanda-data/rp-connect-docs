...
```yml
include::components:example$common/processors/jq.yaml[]
```
...
```yml
include::components:example$advanced/processors/jq.yaml[]
```
...
include::connect:components:partial$fields/processors/jq.adoc[]

include::connect:components:partial$examples/processors/jq.adoc[]
