...
+
--
This configuration uses the https://ollama.com/library/llama-guard3[Llama Guard 3 model^] to check that prompts comply with safety standards. Prompts that do not comply are marked as `unsafe` and deleted.
