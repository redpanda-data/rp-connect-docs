...
```yml
include::components:example$common/processors/ollama_moderation.yaml[]
```
...
```yml
include::components:example$advanced/processors/ollama_moderation.yaml[]
```
...
include::connect:components:partial$fields/processors/ollama_moderation.adoc[]

include::connect:components:partial$examples/processors/ollama_moderation.adoc[]
