...
include::connect:components:partial$fields/processors/openai_chat_completion.adoc[]

nclude::connect:components:partial$examples/processors/openai_chat_completion.adoc[]
