...
:categories: ["Parsing"]
// tag::meta[]
:description: Converts batches of documents to or from https://parquet.apache.org/docs/[Parquet files^].
// end::meta[]
...
include::connect:components:partial$fields/processors/parquet.adoc[]
