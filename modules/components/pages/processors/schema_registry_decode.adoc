...
```yml
include::components:example$common/processors/schema_registry_decode.yaml[]
```
...
```yml
include::components:example$advanced/processors/schema_registry_decode.yaml[]
```
...
include::connect:components:partial$fields/processors/schema_registry_decode.adoc[]
