...
```yml
include::components:example$common/processors/schema_registry_encode.yaml[]
```
...
```yml
include::components:example$advanced/processors/schema_registry_encode.yaml[]
```
...
include::connect:components:partial$fields/processors/schema_registry_encode.adoc[]
