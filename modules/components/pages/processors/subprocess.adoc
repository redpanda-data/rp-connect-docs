...
```yml
include::components:example$common/processors/subprocess.yaml[]
```
...
```yml
include::components:example$advanced/processors/subprocess.yaml[]
```
...
include::connect:components:partial$fields/processors/subprocess.adoc[]
