= Rate Limits
// tag::meta[]
:description: Learn how rate limits work in Redpanda Connect. A rate limit is a named resource that limits use of a shared resource across parallel components.
// end::meta[]
// tag::single-source[]
