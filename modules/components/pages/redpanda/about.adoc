...
For monitoring and troubleshooting guidance, see xref:guides:monitor-pipeline-status.adoc[].
...
* `path`: The configuration path of the connector (see xref:configuration:field_paths.adoc[field paths])
