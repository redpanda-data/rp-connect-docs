...
```yml
include::components:example$common/scanners/avro.yaml[]
```
...
```yml
include::components:example$advanced/scanners/avro.yaml[]
```
...
include::connect:components:partial$metadata/scanners/avro.adoc[]
