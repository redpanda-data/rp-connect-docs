...
For on-premises or self-managed deployments, use the xref:connect:components:inputs/http_server.adoc[`http_server`] input instead.
...
include::connect:components:partial$fields/inputs/gateway.adoc[]
