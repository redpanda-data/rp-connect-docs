...
You can find a full example https://github.com/{project-github}/blob/master/config/examples/joining_streams.yaml[in the project repo^], and with this config we can deploy as many instances of {page-component-title} as we need as the partitions will be balanced across the consumers.
