...
:learning-objective-1: Apply reusable patterns for capturing MongoDB CDC events
:learning-objective-2: Adapt patterns to route CDC data to Redpanda, S3, and other destinations
