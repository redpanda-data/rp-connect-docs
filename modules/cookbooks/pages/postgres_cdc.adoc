...
. Grant the required PostgreSQL privileges:
+
[,sql]
----
...
----
+
NOTE: `ALTER ROLE ... WITH REPLICATION` requires superuser privileges. Run this statement as a superuser, or have a database administrator run it on your behalf.
