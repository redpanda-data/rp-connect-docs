...
The data produced into the topic is consumed and streamed into Snowflake on the order of seconds. You can now go back to the Snowflake worksheet and run the following query to see data show up live, with the
