...
:description: Learn about Redpanda Connect, a declarative connector framework for building data pipelines with simple, chained, stateless processing steps. 
:page-aliases: guides:delivery_guarantee.adoc, streaming:about.adoc
