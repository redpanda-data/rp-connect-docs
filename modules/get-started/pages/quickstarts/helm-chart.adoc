...
Redpanda Connect includes xref:guides:bloblang/walkthrough.adoc[Bloblang], a flexible mapping language for processing data with built-in functions for transformations, random data generation, and more. These functions allow for easy customization of data pipelines.
