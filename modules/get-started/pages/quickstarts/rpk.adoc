...
:page-aliases: getting_started:overview.adoc, guides:getting_started.adoc
...
The `rpk` CLI allows you to create and manage data pipelines with Redpanda Connect as well as xref:streaming:get-started:rpk-install.adoc[interact with Redpanda clusters].
