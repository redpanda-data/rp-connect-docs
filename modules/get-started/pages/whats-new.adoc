...
This release introduces the xref:components:processors/crash.adoc[`crash` processor], which can help you detect unhandled pipeline errors during development and testing.
