...
+
// TODO: Add description for escape_url_path method
** xref:guides:bloblang/methods.adoc#parse_logfmt[`parse_logfmt`]
+
// TODO: Add description for parse_logfmt method
** xref:guides:bloblang/methods.adoc#unescape_url_path[`unescape_url_path`]
+
// TODO: Add description for unescape_url_path method
...
|xref:components:configs/parallel.adoc[parallel]
|Config
|bool
...
* xref:components:rate-limits/redis.adoc#client_name[redis]
...
|extract_tracing_map
|adoc[Bloblang mapping] that attempts to extract an object containing tracing propagation information, which will then be used as the root tracing span for the message. The specification of the extracted fields must match the format used by the service wide tracer.
|*Inputs:*
...
|inject_tracing_map
|adoc[Bloblang mapping] used to inject an object containing tracing propagation information into outbound messages. The specification of the injected fields will match the format used by the service wide tracer.
|*Outputs:*
...
* xref:components:inputs/legacy_redpanda_migrator.adoc#tcp[legacy_redpanda_migrator]
* xref:components:inputs/legacy_redpanda_migrator_offsets.adoc#tcp[legacy_redpanda_migrator_offsets]
...
* xref:components:outputs/legacy_redpanda_migrator.adoc#tcp[legacy_redpanda_migrator]
* xref:components:outputs/legacy_redpanda_migrator_offsets.adoc#tcp[legacy_redpanda_migrator_offsets]
...
* xref:components:inputs/legacy_redpanda_migrator.adoc#regexp_topics_include[legacy_redpanda_migrator]
...
* xref:components:inputs/legacy_redpanda_migrator.adoc#regexp_topics_exclude[legacy_redpanda_migrator]
...
* xref:components:inputs/legacy_redpanda_migrator.adoc#regexp_topics[legacy_redpanda_migrator]
...
* xref:components:inputs/legacy_redpanda_migrator.adoc#metadata_max_age[legacy_redpanda_migrator]
* xref:components:inputs/legacy_redpanda_migrator_offsets.adoc#metadata_max_age[legacy_redpanda_migrator_offsets]
...
* xref:components:outputs/legacy_redpanda_migrator.adoc#metadata_max_age[legacy_redpanda_migrator]
* xref:components:outputs/legacy_redpanda_migrator_offsets.adoc#metadata_max_age[legacy_redpanda_migrator_offsets]
