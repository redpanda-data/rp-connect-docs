...
* Bloblang-functions:
** xref:components:bloblang-functions/bytes.adoc[`bytes`] (stable): Create a new byte array that is zero initialized
* Bloblang-methods:
** xref:components:bloblang-methods/repeat.adoc[`repeat`] (stable)

This release adds support for the following new fields:

* Config:
** xref:components:config/redpanda.adoc[`redpanda`]:
*** xref:components:config/redpanda.adoc#tcp[`tcp`]: TCP socket configuration.
* Caches:
** xref:components:caches/aws_dynamodb.adoc[`aws_dynamodb`]:
*** xref:components:caches/aws_dynamodb.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:caches/aws_s3.adoc[`aws_s3`]:
*** xref:components:caches/aws_s3.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:caches/redpanda.adoc[`redpanda`]:
*** xref:components:caches/redpanda.adoc#tcp[`tcp`]: TCP socket configuration.
* Inputs:
** xref:components:inputs/aws_kinesis.adoc[`aws_kinesis`]:
*** xref:components:inputs/aws_kinesis.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:inputs/aws_s3.adoc[`aws_s3`]:
*** xref:components:inputs/aws_s3.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:inputs/aws_sqs.adoc[`aws_sqs`]:
*** xref:components:inputs/aws_sqs.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:inputs/kafka_franz.adoc[`kafka_franz`]:
*** xref:components:inputs/kafka_franz.adoc#tcp[`tcp`]: TCP socket configuration.
*** xref:components:inputs/kafka_franz.adoc#regexp_topics_include[`regexp_topics_include`]: A list of regular expression patterns for matching topics to consume from.
*** xref:components:inputs/kafka_franz.adoc#regexp_topics_exclude[`regexp_topics_exclude`]: A list of regular expression patterns for excluding topics when regex mode is enabled (via `regexp_topics` or `regexp_topics_include`). Topics matching any of these patterns will be excluded from consumption, even if they match include patterns.
** xref:components:inputs/legacy_redpanda_migrator.adoc[`legacy_redpanda_migrator`]:
*** xref:components:inputs/legacy_redpanda_migrator.adoc#tcp[`tcp`]: TCP socket configuration.
*** xref:components:inputs/legacy_redpanda_migrator.adoc#regexp_topics_include[`regexp_topics_include`]: A list of regular expression patterns for matching topics to consume from.
*** xref:components:inputs/legacy_redpanda_migrator.adoc#regexp_topics_exclude[`regexp_topics_exclude`]: A list of regular expression patterns for excluding topics when regex mode is enabled (via `regexp_topics` or `regexp_topics_include`). Topics matching any of these patterns will be excluded from consumption, even if they match include patterns.
** xref:components:inputs/legacy_redpanda_migrator_offsets.adoc[`legacy_redpanda_migrator_offsets`]:
*** xref:components:inputs/legacy_redpanda_migrator_offsets.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:inputs/microsoft_sql_server_cdc.adoc[`microsoft_sql_server_cdc`]:
*** xref:components:inputs/microsoft_sql_server_cdc.adoc#max_parallel_snapshot_tables[`max_parallel_snapshot_tables`]: Specifies a number of tables that will be processed in parallel during the snapshot processing stage.
** xref:components:inputs/pg_stream.adoc[`pg_stream`]:
*** xref:components:inputs/pg_stream.adoc#tls[`tls`]: Custom TLS settings can be used to override system defaults.
** xref:components:inputs/postgres_cdc.adoc[`postgres_cdc`]:
*** xref:components:inputs/postgres_cdc.adoc#tls[`tls`]: Custom TLS settings can be used to override system defaults.
** xref:components:inputs/redpanda.adoc[`redpanda`]:
*** xref:components:inputs/redpanda.adoc#tcp[`tcp`]: TCP socket configuration.
*** xref:components:inputs/redpanda.adoc#regexp_topics_include[`regexp_topics_include`]: A list of regular expression patterns for matching topics to consume from.
*** xref:components:inputs/redpanda.adoc#regexp_topics_exclude[`regexp_topics_exclude`]: A list of regular expression patterns for excluding topics when regex mode is enabled (via `regexp_topics` or `regexp_topics_include`). Topics matching any of these patterns will be excluded from consumption, even if they match include patterns.
** xref:components:inputs/redpanda_common.adoc[`redpanda_common`]:
*** xref:components:inputs/redpanda_common.adoc#regexp_topics_include[`regexp_topics_include`]: A list of regular expression patterns for matching topics to consume from.
*** xref:components:inputs/redpanda_common.adoc#regexp_topics_exclude[`regexp_topics_exclude`]: A list of regular expression patterns for excluding topics when regex mode is enabled (via `regexp_topics` or `regexp_topics_include`). Topics matching any of these patterns will be excluded from consumption, even if they match include patterns.
** xref:components:inputs/redpanda_migrator.adoc[`redpanda_migrator`]:
*** xref:components:inputs/redpanda_migrator.adoc#tcp[`tcp`]: TCP socket configuration.
*** xref:components:inputs/redpanda_migrator.adoc#regexp_topics_include[`regexp_topics_include`]: A list of regular expression patterns for matching topics to consume from.
*** xref:components:inputs/redpanda_migrator.adoc#regexp_topics_exclude[`regexp_topics_exclude`]: A list of regular expression patterns for excluding topics when regex mode is enabled (via `regexp_topics` or `regexp_topics_include`). Topics matching any of these patterns will be excluded from consumption, even if they match include patterns.
* Outputs:
** xref:components:outputs/amqp_1.adoc[`amqp_1`]:
*** xref:components:outputs/amqp_1.adoc#persistent[`persistent`]: If set to true, the message will be marked as persistent, ensuring it is stored durably and not lost if an intermediary (such as a broker) restarts. By default, messages are not durable.
*** xref:components:outputs/amqp_1.adoc#target_capabilities[`target_capabilities`]: Lists the extension capabilities the sender desires from the target, such as support for queues, topics, durability, sharing, or temporary destinations.
*** xref:components:outputs/amqp_1.adoc#message_properties_to[`message_properties_to`]: The field specifies the node that is the intended destination of the message, which may differ from the node currently receiving the transfer.
** xref:components:outputs/aws_dynamodb.adoc[`aws_dynamodb`]:
*** xref:components:outputs/aws_dynamodb.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/aws_kinesis.adoc[`aws_kinesis`]:
*** xref:components:outputs/aws_kinesis.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/aws_kinesis_firehose.adoc[`aws_kinesis_firehose`]:
*** xref:components:outputs/aws_kinesis_firehose.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/aws_s3.adoc[`aws_s3`]:
*** xref:components:outputs/aws_s3.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/aws_sns.adoc[`aws_sns`]:
*** xref:components:outputs/aws_sns.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/aws_sqs.adoc[`aws_sqs`]:
*** xref:components:outputs/aws_sqs.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/kafka_franz.adoc[`kafka_franz`]:
*** xref:components:outputs/kafka_franz.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/legacy_redpanda_migrator.adoc[`legacy_redpanda_migrator`]:
*** xref:components:outputs/legacy_redpanda_migrator.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/legacy_redpanda_migrator_offsets.adoc[`legacy_redpanda_migrator_offsets`]:
*** xref:components:outputs/legacy_redpanda_migrator_offsets.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/redpanda.adoc[`redpanda`]:
*** xref:components:outputs/redpanda.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:outputs/redpanda_migrator.adoc[`redpanda_migrator`]:
*** xref:components:outputs/redpanda_migrator.adoc#tcp[`tcp`]: TCP socket configuration.
*** xref:components:outputs/redpanda_migrator.adoc#provenance_header[`provenance_header`]: Header name to add to migrated records indicating their source cluster. If empty, no provenance header is added.
* Processors:
** xref:components:processors/aws_bedrock_chat.adoc[`aws_bedrock_chat`]:
*** xref:components:processors/aws_bedrock_chat.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:processors/aws_bedrock_embeddings.adoc[`aws_bedrock_embeddings`]:
*** xref:components:processors/aws_bedrock_embeddings.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:processors/aws_dynamodb_partiql.adoc[`aws_dynamodb_partiql`]:
*** xref:components:processors/aws_dynamodb_partiql.adoc#tcp[`tcp`]: TCP socket configuration.
** xref:components:processors/aws_lambda.adoc[`aws_lambda`]:
*** xref:components:processors/aws_lambda.adoc#tcp[`tcp`]: TCP socket configuration.
* Metrics:
** xref:components:metrics/aws_cloudwatch.adoc[`aws_cloudwatch`]:
*** xref:components:metrics/aws_cloudwatch.adoc#tcp[`tcp`]: TCP socket configuration.
...
* Inputs components
** xref:components:inputs/kafka_franz.adoc[`kafka_franz`]: xref:components:inputs/kafka_franz.adoc#regexp_topics[`regexp_topics`]
** xref:components:inputs/legacy_redpanda_migrator.adoc[`legacy_redpanda_migrator`]: xref:components:inputs/legacy_redpanda_migrator.adoc#regexp_topics[`regexp_topics`]
** xref:components:inputs/redpanda.adoc[`redpanda`]: xref:components:inputs/redpanda.adoc#regexp_topics[`regexp_topics`]
** xref:components:inputs/redpanda_common.adoc[`redpanda_common`]: xref:components:inputs/redpanda_common.adoc#regexp_topics[`regexp_topics`]
** xref:components:inputs/redpanda_migrator.adoc[`redpanda_migrator`]: xref:components:inputs/redpanda_migrator.adoc#regexp_topics[`regexp_topics`]
