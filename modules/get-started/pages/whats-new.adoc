...
This release marks the General Availability (GA) of Redpanda Connect across all Redpanda Cloud platforms:
...
Redpanda Connect Self-Managed is GA from version 4.29.0 onwards.
