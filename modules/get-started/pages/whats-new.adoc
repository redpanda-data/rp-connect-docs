...
The following CLI commands have been deprecated and removed:

- `rpk connect mcp-server` - Start an MCP server for Redpanda Connect configurations
- `rpk connect mcp-server init` - Initialize an MCP server configuration
- `rpk connect mcp-server lint` - Lint an MCP server configuration

These commands were part of the Remote MCP feature, which has been deprecated.
