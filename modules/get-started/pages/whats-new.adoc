...
|tcp
|adoc[synchronous responses].
|*Inputs:*

* xref:components:inputs/gateway.adoc#tcp[gateway]
...
* xref:components:inputs/mysql_cdc.adoc#max_reconnect_attempts[mysql_cdc]
...
* xref:components:inputs/mysql_cdc.adoc#tls[mysql_cdc]
...
* xref:components:inputs/mysql_cdc.adoc#aws[mysql_cdc]
