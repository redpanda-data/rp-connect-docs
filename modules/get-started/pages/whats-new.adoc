...
This release introduces a dynamic xref:plugins:about.adoc[plugins] framework that enables you to create and load custom plugins at runtime using any programming language that supports gRPC - with initial SDKs for Go and Python.
