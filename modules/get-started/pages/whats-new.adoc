...
* Outputs:
** xref:components:outputs/cyborgdb.adoc[`cyborgdb`] (experimental): 
...
* Bloblang-functions:
** xref:components:bloblang-functions/with_schema_registry_header.adoc[`with_schema_registry_header`] (beta): Prepends a 5-byte Schema Registry header to a message. The header consists of a magic byte (0x00) followed by a 4-byte big-endian schema ID.
