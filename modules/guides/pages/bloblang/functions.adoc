...
Returns the name of the component that raised the error during the processing of a message. A `null` is returned when the error is null or no component is associated with the error. For more information about error-handling patterns read xref:configuration:error_handling.adoc[].
...
Returns the path of the component that raised the error during the processing of a message. A `null` is returned when the error is null or no component is associated with the error. For more information about error-handling patterns read xref:configuration:error_handling.adoc[].
