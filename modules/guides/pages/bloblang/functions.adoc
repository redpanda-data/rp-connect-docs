...
Returns the label of the source component that raised the error during the processing of a message, or an empty string if not set. A `null` is returned when the error is null or no source component is associated with the error. For more information about error-handling patterns read xref:configuration:error_handling.adoc[].
...
Returns the name of the source component that raised the error during the processing of a message. A `null` is returned when the error is null or no source component is associated with the error. For more information about error-handling patterns read xref:configuration:error_handling.adoc[].
...
Returns the path of the source component that raised the error during the processing of a message. A `null` is returned when the error is null or no source component is associated with the error. For more information about error-handling patterns read xref:configuration:error_handling.adoc[].
