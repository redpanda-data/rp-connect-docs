...
Attempts to parse a value into a timestamp. You can also provide an optional argument. The argument is returned when the value cannot be parsed into a timestamp.
