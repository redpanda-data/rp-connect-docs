...
The long deprecated `mmap_file` buffer has been removed. If you were still relying on this buffer implementation then please https://github.com/Jeffail/benthos/issues[raise an issue].
