...
:page-objectives: Consume status events from a Kafka topic | Configure alerts for pipeline failures and connection errors | Troubleshoot common status reporting issues
