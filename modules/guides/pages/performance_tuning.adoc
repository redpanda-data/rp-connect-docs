...
TIP: For a worked example that combines in-flight messages, batching, and buffers, see xref:guides:iceberg-output-tuning.adoc[Tune the Iceberg output for throughput].
